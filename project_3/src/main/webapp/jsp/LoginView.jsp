							...
							<div class="card-body">
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="password" class="form-control input-group-addon" name="password"
								...
								<div class="text-center">
									<input type="submit" name="operation" class="btn btn-success btn-md hover-overlayed"
										style="font-size: 17px" value="<%=LoginCtl.OP_SIGN_IN%>">

									<input type="submit" name="operation" class="btn btn-primary btn-md"
										style="font-size: 17px" value="<%=UserRegistrationCtl.OP_SIGN_UP%>">
								</div>

								<div class="text-center">
									<a href="<%=ORSView.FORGET_PASSWORD_CTL%>" style="color: black; font-size: 15px;">
										<b><u>Forget my password ?</u></b>
									</a>
								</div>
