		...
		<div class="collapse navbar-collapse" id="navbarNav">
			...
			<ul class="nav navbar-nav ml-auto">
				...
				<%-- 	<li class="nav-item dropdown" style="padding-left: 5px"><a
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"> <font style="color: white;">Shoping
					</font></a>

					<div class="dropdown-menu" aria-labelledby="navbarDropdown">

						<a class="dropdown-item" href="<%=ORSView.SHOPING_CTL%>"><i
							class="fa fa-file"></i>Add Shoping</a> <a class="dropdown-item"
							href="<%=ORSView.SHOPING_LIST_CTL%>"><i class="fa fa-paste"></i>Shoping
							List</a>
					</div></li> --%>
				<%-- <li class="nav-item dropdown" style="padding-left: 5px"><a
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"> <font style="color: white;">Order
					</font></a>

					<div class="dropdown-menu" aria-labelledby="navbarDropdown">

						<a class="dropdown-item" href="<%=ORSView.ORDER_CTL%>"><i
							class="fa fa-file"></i>Add Order</a> <a class="dropdown-item"
							href="<%=ORSView.ORDER_LIST_CTL%>"><i class="fa fa-paste"></i>Order
							List</a>
					</div></li> --%>
				<%-- 		<li class="nav-item dropdown" style="padding-left: 5px"><a
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"> <font style="color: white;">Project
					</font></a>

					<div class="dropdown-menu" aria-labelledby="navbarDropdown">

						<a class="dropdown-item" href="<%=ORSView.PROJECT_CTL%>"><i
							class="fa fa-file"></i>Add Project</a> <a class="dropdown-item"
							href="<%=ORSView.PROJECT_LIST_CTL%>"><i class="fa fa-paste"></i>Project
							List</a>
					</div></li>
 --%>
				<li class="nav-item dropdown" style="padding-left: 5px"><a
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"> <font style="color: white;">ATm </font></a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="<%=ORSView.ATM_CTL%>"><i
							class="fa fa-user-tie"></i>Add ATM</a> <a class="dropdown-item"
							href="<%=ORSView.ATM_LIST_CTL%>"><i class=" fa fa-users"></i>ATM
							List</a>
					</div></li>
				...
				<li class="nav-item dropdown" style="padding-left: 5px"><a
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"> <font style="color: white;">Position </font></a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="<%=ORSView.POSITION_CTL%>"><i
							class="fa fa-user-tie"></i>Add Position</a> <a class="dropdown-item"
							href="<%=ORSView.POSITION_LIST_CTL%>"><i class=" fa fa-users"></i>Position
							List</a>
					</div></li>
					<li class="nav-item dropdown" style="padding-left: 5px"><a
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"> <font style="color: white;">Client </font></a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="<%=ORSView.CLIENT_CTL%>"><i
							class="fa fa-user-tie"></i>Add Client</a> <a class="dropdown-item"
							href="<%=ORSView.CLIENT_LIST_CTL%>"><i class=" fa fa-users"></i>Client
							List</a>
					</div></li>
				...
				<%-- <li class="nav-item dropdown" style="padding-left: 5px"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="<%=ORSView.INVENTORY_CTL%>"><i
							class="fa fa-calculator"></i>Add Inventory</a> <a
							class="dropdown-item" href="<%=ORSView.INVENTORY_LIST_CTL%>">
							<i class="fa fa-sort-amount-down"></i>Inventory List
						</a> --%>
				<%-- 	</div></li>
				<li class="nav-item dropdown" style="padding-left: 5px"><a
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="<%=ORSView.SUPPLIER_CTL%>"><i
							class="fa fa-calculator"></i>Add Supplier</a> <a
							class="dropdown-item" href="<%=ORSView.SUPPLIER_LIST_CTL%>">
							<i class="fa fa-sort-amount-down"></i>Supplier List
						</a> --%>
				<%-- </div></li>
					<li class="nav-item dropdown" style="padding-left: 5px"><a
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"> <font style="color: white;">Transpot</font>
				</a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="<%=ORSView.TRANS_CTL%>"><i
							class="fa fa-calculator"></i>Add Transport</a> <a
							class="dropdown-item" href="<%=ORSView.TRANS_LIST_CTL%>">
							<i class="fa fa-sort-amount-down"></i>Transport List
						</a>
					</div></li>
 --%>
				<%
