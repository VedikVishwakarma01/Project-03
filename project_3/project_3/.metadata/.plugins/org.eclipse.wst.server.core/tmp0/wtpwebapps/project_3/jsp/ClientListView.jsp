...
<style>
.hm {
	background-image: url('<%=ORSView.APP_CONTEXT%>/img/proj33.jpg');
...
<body class="hm">
	<div>
		<form class="pb-5" action="<%=ORSView.CLIENT_LIST_CTL%>"
			method="post">
			...
			&emsp;
				<div class="col-sm-2">
					<input type="text" name="Dob" placeholder="Enter Dob" readonly="readonly"
				...
				<%-- <div class="col-sm-3"><%=HTMLUtility.getList("Location", String.valueOf(dto.getLocation()), map)%></div>
 --%>
				...
				<table class="table table-bordered table-dark table-hover">
					<thead>
						<tr style="background-color: #8C8C8C;">
							...
							<th width="15%" class="text">ContactNa,me</th>
							<th width="15%" class="text">Date</th>
							<th width="20%" class="text">Location</th>
							<th width="10%" class="text">Phone</th>
			...
			%>
			<center>
				<h1 style="font-size: 40px; color: #162390;"> List</h1>
			</center>
			</br>
			<div class="row">
				<div class="col-md-4"></div>
